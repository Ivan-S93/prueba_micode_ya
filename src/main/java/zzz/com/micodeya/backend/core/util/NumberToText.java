...
public class NumberToText {
	...
	public NumberToText(BigDecimal n){
		if(n.scale() > 0){
				throw new KwfCoreException("No se puede transformar a texto valor numérico con decimal "+n.toString());
		} 
	...
	public String convertirLetras(BigDecimal numero){
		if(numero.scale() > 0){
				throw new KwfCoreException("No se puede convertir a texto valor numérico con decimal "+numero.toString());
		} 
		

		num_letras = decmillon(numero.intValue());
		return num_letras;
	} 	
}

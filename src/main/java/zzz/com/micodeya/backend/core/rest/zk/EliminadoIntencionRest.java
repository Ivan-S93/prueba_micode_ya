...
@Slf4j
@RestController
public class EliminadoIntencionRest {

    private final String BASE_API = "/api/zk/eliminadoIntencion";

    @Autowired
    private EliminadoIntencionDao eliminadoIntencionDao;
    ...
    public Map<String, Object> listar(
        ...
        Integer[] idRecursoPermisoArray = { 6, 26 };
        JeResponse jeResponse=new JeResponse("Listado correcto de Eliminado Intencion","Error grave al listar Eliminado Intencion");
        ...
        try {
            ...
            if (jeResponse.sinErrorValidacion()) {
                jeResponse.putResultadoListar(eliminadoIntencionDao.listarAtributosPorPagina(new EliminadoIntencion(), paginacionAux.getAtributos(), paginacionAux));
            }
